...
rem  Work out 64- vs 32-bit, then fetch the matching official installer.
...
set "ARCH=amd64"
if /i "%PROCESSOR_ARCHITECTURE%"=="x86" if not defined PROCESSOR_ARCHITEW6432 set "ARCH=win32"
if /i "%PROCESSOR_ARCHITECTURE%"=="ARM64" set "ARCH=arm64"
if /i "%ARCH%"=="win32" set "ARCH=amd64"
rem  (32-bit builds stopped at 3.12; anything running Windows 10 or 11 is 64-bit)
